<?php /* Smarty version Smarty-3.1.19, created on 2017-10-25 07:51:04
         compiled from "/Applications/AMPPS/www/proiect/themes/warehouse/category.tpl" */ ?>
<?php /*%%SmartyHeaderCode:16615736359f07aa86a3cf6-92063208%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '482f8e739fd8a485e58025fe3ddd272f48b7ebfa' => 
    array (
      0 => '/Applications/AMPPS/www/proiect/themes/warehouse/category.tpl',
      1 => 1508698052,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '16615736359f07aa86a3cf6-92063208',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_59f07aa88326a4_71965743',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_59f07aa88326a4_71965743')) {function content_59f07aa88326a4_71965743($_smarty_tpl) {?>
...
" class="img-responsive cat_img_bg"/><?php }?>
...
" class="btn btn-default pull-right" c><i class="icon-minus"></i> <?php echo smartyTranslate(array('s'=>'Less'),$_smarty_tpl);?>
</a>
                                </div>
...
" class="img">
						<?php if ($_smarty_tpl->tpl_vars['subcategory']->value['id_image']) {?>
							<img class="img-responsive replace-2x" src="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getCatImageLink($_smarty_tpl->tpl_vars['subcategory']->value['link_rewrite'],$_smarty_tpl->tpl_vars['subcategory']->value['id_image'],'medium_default'), ENT_QUOTES, 'UTF-8', true);?>
...
-default-category_thumbs.jpg" alt="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['subcategory']->value['name'], ENT_QUOTES, 'UTF-8', true);?>
" />
						<?php }?>
					</a>
                   	</div>
...
"><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['truncate'][0][0]->smarty_modifier_truncate(htmlspecialchars($_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['truncate'][0][0]->smarty_modifier_truncate($_smarty_tpl->tpl_vars['subcategory']->value['name'],35,'...'), ENT_QUOTES, 'UTF-8', true),350);?>
</a></h5>
				</li>
			<?php } ?>
			</ul>
     ...
     <?php if (((isset($_smarty_tpl->tpl_vars['warehouse_vars']->value['desc_style'])&&$_smarty_tpl->tpl_vars['warehouse_vars']->value['desc_style']==2&&$_smarty_tpl->tpl_vars['warehouse_vars']->value['show_desc'])&&$_smarty_tpl->tpl_vars['category']->value->description)) {?> 
