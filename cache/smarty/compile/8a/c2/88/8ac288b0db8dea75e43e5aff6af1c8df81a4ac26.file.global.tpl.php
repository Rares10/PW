<?php /* Smarty version Smarty-3.1.19, created on 2017-10-23 15:55:21
         compiled from "/Applications/AMPPS/www/proiect/themes/warehouse/global.tpl" */ ?>
<?php /*%%SmartyHeaderCode:187860768559ee4929909cb0-74185012%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '8ac288b0db8dea75e43e5aff6af1c8df81a4ac26' => 
    array (
      0 => '/Applications/AMPPS/www/proiect/themes/warehouse/global.tpl',
      1 => 1508698052,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '187860768559ee4929909cb0-74185012',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_59ee49299d5db0_43134277',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_59ee49299d5db0_43134277')) {function content_59ee49299d5db0_43134277($_smarty_tpl) {?>
...
<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['addJsDef'][0][0]->addJsDef(array('displayList'=>intval($_smarty_tpl->tpl_vars['warehouse_vars']->value['productlist_view'])),$_smarty_tpl);?>
<?php if (isset($_smarty_tpl->tpl_vars['warehouse_vars']->value['is_rtl'])&&$_smarty_tpl->tpl_vars['warehouse_vars']->value['is_rtl']) {?><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['addJsDef'][0][0]->addJsDef(array('isRtl'=>$_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['boolval'][0][0]->boolval(true)),$_smarty_tpl);?>
<?php } else { ?><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['addJsDef'][0][0]->addJsDef(array('isRtl'=>$_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['boolval'][0][0]->boolval(false)),$_smarty_tpl);?>
<?php }?><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['addJsDef'][0][0]->addJsDef(array('grid_size_lg'=>intval($_smarty_tpl->tpl_vars['warehouse_vars']->value['grid_size_lg'])),$_smarty_tpl);?>
...
<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['addJsDef'][0][0]->addJsDef(array('grid_size_xs'=>intval($_smarty_tpl->tpl_vars['warehouse_vars']->value['grid_size_xs'])),$_smarty_tpl);?>
...
if (!empty($_capture_buffer)) {
 ...
 if (isset( $_capture_append)) $_smarty_tpl->append( $_capture_append, ob_get_contents());
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
} else $_smarty_tpl->capture_error();?><?php $_smarty_tpl->_capture_stack[0][] = array("nbItemsPerLineMobileS", null, null); ob_start(); ?><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['hook'][0][0]->smartyHook(array('h'=>'calculateGrid','size'=>'xtrasmall'),$_smarty_tpl);?>
<?php list($_capture_buffer, $_capture_assign, $_capture_append) = array_pop($_smarty_tpl->_capture_stack[0]);
if (!empty($_capture_buffer)) {
 if (isset($_capture_assign)) $_smarty_tpl->assign($_capture_assign, ob_get_contents());
 if (isset( $_capture_append)) $_smarty_tpl->append( $_capture_append, ob_get_contents());
...
<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['addJsDef'][0][0]->addJsDef(array('grid_size_xs2'=>intval(Smarty::$_smarty_vars['capture']['nbItemsPerLineMobileS'])),$_smarty_tpl);?>
