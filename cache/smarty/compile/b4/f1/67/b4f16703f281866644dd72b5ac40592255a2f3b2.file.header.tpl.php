<?php /* Smarty version Smarty-3.1.19, created on 2017-10-23 15:55:20
         compiled from "/Applications/AMPPS/www/proiect/themes/warehouse/header.tpl" */ ?>
<?php /*%%SmartyHeaderCode:175649717659ee49289a6f97-85009698%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'b4f16703f281866644dd72b5ac40592255a2f3b2' => 
    array (
      0 => '/Applications/AMPPS/www/proiect/themes/warehouse/header.tpl',
      1 => 1508698052,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '175649717659ee49289a6f97-85009698',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_59ee4928d2fd91_34837930',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_59ee4928d2fd91_34837930')) {function content_59ee4928d2fd91_34837930($_smarty_tpl) {?><?php if (!is_callable('smarty_function_implode')) include '/Applications/AMPPS/www/proiect/tools/smarty/plugins/function.implode.php';
?>
<!DOCTYPE HTML>
...
<?php if (isset($_smarty_tpl->tpl_vars['geolocation_country']->value)&&$_smarty_tpl->tpl_vars['geolocation_country']->value) {?> <span class="bold"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['geolocation_country']->value, ENT_QUOTES, 'UTF-8', true);?>
	...
	<div id="page">
		<div class="header-container<?php if (isset($_smarty_tpl->tpl_vars['warehouse_vars']->value['header_style'])) {?><?php if ($_smarty_tpl->tpl_vars['warehouse_vars']->value['header_style']==1) {?> sidebar-header<?php } elseif (($_smarty_tpl->tpl_vars['warehouse_vars']->value['header_style']==2||$_smarty_tpl->tpl_vars['warehouse_vars']->value['header_style']==3)) {?> inline-header<?php }?><?php }?><?php if (isset($_smarty_tpl->tpl_vars['warehouse_vars']->value['cart_style'])&&$_smarty_tpl->tpl_vars['warehouse_vars']->value['cart_style']==1) {?> alt-cart<?php }?>">
			<header id="header">
...
" />
								...
								<div class="inline-cell-noflex"><?php if (isset($_smarty_tpl->tpl_vars['HOOK_TOP']->value)) {?><?php echo $_smarty_tpl->tpl_vars['HOOK_TOP']->value;?>
<?php }?></div>
									</div>
								</div>
...
<?php }?>
 ...
 <?php if ($_smarty_tpl->tpl_vars['warehouse_vars']->value['mobile_header_search']) {?>mobile-search-expanded<?php }?>">
						...
						<?php if ($_smarty_tpl->tpl_vars['warehouse_vars']->value['mobile_header_style']==1) {?>
							<?php echo $_smarty_tpl->getSubTemplate (((string)$_smarty_tpl->tpl_vars['tpl_dir']->value)."./mobile-header1.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0);?>

						<?php } elseif ($_smarty_tpl->tpl_vars['warehouse_vars']->value['mobile_header_style']==2) {?>
							<?php echo $_smarty_tpl->getSubTemplate (((string)$_smarty_tpl->tpl_vars['tpl_dir']->value)."./mobile-header2.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0);?>

						<?php } elseif ($_smarty_tpl->tpl_vars['warehouse_vars']->value['mobile_header_style']==3) {?>
							<?php echo $_smarty_tpl->getSubTemplate (((string)$_smarty_tpl->tpl_vars['tpl_dir']->value)."./mobile-header3.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0);?>

						<?php }?>

						<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['hook'][0][0]->smartyHook(array('h'=>'iqitMobileHeader'),$_smarty_tpl);?>
				...
				<div class="fw-pseudo-wrapper"> <div class="desktop-header"><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['hook'][0][0]->smartyHook(array('h'=>'maxHeader'),$_smarty_tpl);?>
 </div>	</div>
