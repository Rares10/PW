...
<?php /*%%SmartyHeaderCode:105524962859ee4926562e76-96154241%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '105524962859ee4926562e76-96154241',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_59ee49267eada1_81808898',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_59ee49267eada1_81808898')) {function content_59ee49267eada1_81808898($_smarty_tpl) {?>
				...
				<?php } elseif ($_smarty_tpl->tpl_vars['node']->value['contentType']==2) {?>
					...
					<?php if (isset($_smarty_tpl->tpl_vars['node']->value['content']['products'])) {?>
						...
						<?php if ($_smarty_tpl->tpl_vars['node']->value['content']['view']==0) {?>
							<?php echo $_smarty_tpl->getSubTemplate (((string)$_smarty_tpl->tpl_vars['tpl_dir']->value)."./product-list.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 9999, null, array('image_types'=>$_smarty_tpl->tpl_vars['images_types']->value,'image_type'=>$_smarty_tpl->tpl_vars['node']->value['content']['itype'],'productimg'=>$_smarty_tpl->tpl_vars['node']->value['content']['productsimg'],'products'=>$_smarty_tpl->tpl_vars['node']->value['content']['products'],'generatorGrid'=>"col-xs-".((string)$_smarty_tpl->tpl_vars['node']->value['content']['line_xs'])." col-ms-".((string)$_smarty_tpl->tpl_vars['node']->value['content']['line_ms'])." col-sm-".((string)$_smarty_tpl->tpl_vars['node']->value['content']['line_sm'])." col-md-".((string)$_smarty_tpl->tpl_vars['node']->value['content']['line_md'])." col-lg-".((string)$_smarty_tpl->tpl_vars['node']->value['content']['line_lg'])), 0);?>

						<?php } elseif ($_smarty_tpl->tpl_vars['node']->value['content']['view']==1) {?>
							<?php echo $_smarty_tpl->getSubTemplate (((string)$_smarty_tpl->tpl_vars['tpl_dir']->value)."./product-slider.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 9999, null, array('image_types'=>$_smarty_tpl->tpl_vars['images_types']->value,'image_type'=>$_smarty_tpl->tpl_vars['node']->value['content']['itype'],'productimg'=>$_smarty_tpl->tpl_vars['node']->value['content']['productsimg'],'ar'=>$_smarty_tpl->tpl_vars['node']->value['content']['ar'],'ap'=>$_smarty_tpl->tpl_vars['node']->value['content']['ap'],'dt'=>$_smarty_tpl->tpl_vars['node']->value['content']['dt'],'colnb'=>$_smarty_tpl->tpl_vars['node']->value['content']['colnb'],'products'=>$_smarty_tpl->tpl_vars['node']->value['content']['products'],'iqitGenerator'=>1,'line_xs'=>$_smarty_tpl->tpl_vars['node']->value['content']['line_xs'],'line_ms'=>$_smarty_tpl->tpl_vars['node']->value['content']['line_ms'],'line_sm'=>$_smarty_tpl->tpl_vars['node']->value['content']['line_sm'],'line_md'=>$_smarty_tpl->tpl_vars['node']->value['content']['line_md'],'line_lg'=>$_smarty_tpl->tpl_vars['node']->value['content']['line_lg']), 0);?>

						<?php } elseif ($_smarty_tpl->tpl_vars['node']->value['content']['view']==2) {?>
							<?php echo $_smarty_tpl->getSubTemplate (((string)$_smarty_tpl->tpl_vars['tpl_dir']->value)."./product-list-small.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 9999, null, array('image_types'=>$_smarty_tpl->tpl_vars['images_types']->value,'image_type'=>$_smarty_tpl->tpl_vars['node']->value['content']['itype'],'productimg'=>$_smarty_tpl->tpl_vars['node']->value['content']['productsimg'],'products'=>$_smarty_tpl->tpl_vars['node']->value['content']['products'],'generatorGrid'=>"col-xs-".((string)$_smarty_tpl->tpl_vars['node']->value['content']['line_xs'])." col-ms-".((string)$_smarty_tpl->tpl_vars['node']->value['content']['line_ms'])." col-sm-".((string)$_smarty_tpl->tpl_vars['node']->value['content']['line_sm'])." col-md-".((string)$_smarty_tpl->tpl_vars['node']->value['content']['line_md'])." col-lg-".((string)$_smarty_tpl->tpl_vars['node']->value['content']['line_lg'])), 0);?>

						<?php } else { ?>
							<?php echo $_smarty_tpl->getSubTemplate (((string)$_smarty_tpl->tpl_vars['tpl_dir']->value)."./product-list-small.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 9999, null, array('image_types'=>$_smarty_tpl->tpl_vars['images_types']->value,'image_type'=>$_smarty_tpl->tpl_vars['node']->value['content']['itype'],'productimg'=>$_smarty_tpl->tpl_vars['node']->value['content']['productsimg'],'ar'=>$_smarty_tpl->tpl_vars['node']->value['content']['ar'],'ap'=>$_smarty_tpl->tpl_vars['node']->value['content']['ap'],'dt'=>$_smarty_tpl->tpl_vars['node']->value['content']['dt'],'colnb'=>$_smarty_tpl->tpl_vars['node']->value['content']['colnb'],'products'=>$_smarty_tpl->tpl_vars['node']->value['content']['products'],'iqitGenerator'=>1,'line_xs'=>$_smarty_tpl->tpl_vars['node']->value['content']['line_xs'],'line_ms'=>$_smarty_tpl->tpl_vars['node']->value['content']['line_ms'],'line_sm'=>$_smarty_tpl->tpl_vars['node']->value['content']['line_sm'],'line_md'=>$_smarty_tpl->tpl_vars['node']->value['content']['line_md'],'line_lg'=>$_smarty_tpl->tpl_vars['node']->value['content']['line_lg']), 0);?>
