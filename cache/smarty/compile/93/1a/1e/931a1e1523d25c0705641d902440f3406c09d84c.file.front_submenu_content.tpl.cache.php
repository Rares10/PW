<?php /* Smarty version Smarty-3.1.19, created on 2017-10-23 15:55:21
         compiled from "/Applications/AMPPS/www/proiect/modules/iqitmegamenu/views/templates/hook/front_submenu_content.tpl" */ ?>
<?php /*%%SmartyHeaderCode:154333203159ee49291683f7-55090289%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '931a1e1523d25c0705641d902440f3406c09d84c' => 
    array (
      0 => '/Applications/AMPPS/www/proiect/modules/iqitmegamenu/views/templates/hook/front_submenu_content.tpl',
      1 => 1508698056,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '154333203159ee49291683f7-55090289',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_59ee49292a1f19_20842173',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_59ee49292a1f19_20842173')) {function content_59ee49292a1f19_20842173($_smarty_tpl) {?>
...
" class="cbp-column-title cbp-category-title"><?php echo $_smarty_tpl->tpl_vars['category']->value['title'];?>
										...
										<?php if (isset($_smarty_tpl->tpl_vars['category']->value['children'])) {?><?php echo $_smarty_tpl->getSubTemplate ("./front_subcategory.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 9999, null, array('categories'=>$_smarty_tpl->tpl_vars['category']->value['children'],'level'=>1), 0);?>
<?php }?>
									</div>
									<?php }?>
								<?php } ?>
...
"><?php echo $_smarty_tpl->tpl_vars['category']->value['title'];?>
										...
										<?php if (isset($_smarty_tpl->tpl_vars['category']->value['children'])) {?><?php echo $_smarty_tpl->getSubTemplate ("./front_subcategory.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 9999, null, array('categories'=>$_smarty_tpl->tpl_vars['category']->value['children'],'level'=>2), 0);?>
<?php }?></div>
									</li>
									<?php }?>
								<?php } ?>
				...
				<?php } elseif ($_smarty_tpl->tpl_vars['node']->value['contentType']==4) {?>
					...
					<?php if (isset($_smarty_tpl->tpl_vars['node']->value['content']['ids'])) {?>
						<?php if ($_smarty_tpl->tpl_vars['node']->value['content']['view']) {?>
							<?php echo $_smarty_tpl->getSubTemplate ("./products_grid.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 9999, null, array('products'=>$_smarty_tpl->tpl_vars['node']->value['content']['ids'],'perline'=>$_smarty_tpl->tpl_vars['node']->value['content']['line']), 0);?>

						<?php } else { ?>
							<?php echo $_smarty_tpl->getSubTemplate ("./products_list.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 9999, null, array('products'=>$_smarty_tpl->tpl_vars['node']->value['content']['ids'],'perline'=>$_smarty_tpl->tpl_vars['node']->value['content']['line']), 0);?>
...
<?php $_tmp11=ob_get_clean();?><?php $_smarty_tpl->tpl_vars["myfile"] = new Smarty_variable("img/m/".$_tmp11."-mf_image.jpg", null, 0);?>
...
" title="Manufacturer - <?php echo mb_convert_encoding(htmlspecialchars(Manufacturer::getNameById($_smarty_tpl->tpl_vars['manufacturer']->value), ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
">
...
"<?php }?> alt="Manufacturer - <?php echo mb_convert_encoding(htmlspecialchars(Manufacturer::getNameById($_smarty_tpl->tpl_vars['manufacturer']->value), ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
" />
								</a>
							</li>
							<?php }?>
...
" class="img-responsive cbp-banner-image" alt=" " />
...
?>
			<?php echo $_smarty_tpl->getSubTemplate ("./front_submenu_content.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 9999, null, array('node'=>$_smarty_tpl->tpl_vars['child']->value), 0);?>
